...
def get_distance_time_relate(point_a, point_b, ts, rp_t=0.5, rp_s=0.5, bend_radio=1, rp=()):
    """
    获取距离时间关系函数
...
def start_generate_trace(start_coordinate, end_coordinate, show=True):

    t = generate_mouse_trace_between_two_point(start_coordinate, end_coordinate, show=show, dense_radio=0.1)
    print(t)
...
if __name__ == '__main__':
    ...
    # b = (button_coordinate[0], button_coordinate[1])
    # print(a)
    # print(b)
    start_coordinate = (0, 0)
    end_coordinate = (110, random.randint(1, 10))
    print(start_coordinate, end_coordinate)
    t = generate_mouse_trace_between_two_point(start_coordinate, end_coordinate, show=True, dense_radio=0.4)
    print(t)